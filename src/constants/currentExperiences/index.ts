...
export const EN_CURRENT_EXPERIENCES: Experience[] = [
	{
		title: "Nov/2022 - Present",
		cardTitle: "Software Developer",
		cardSubtitle: "Radix Engineering and Software",
		cardDetailedText: [
			"Support and evolution of the Technos Group applications. In this project, I work on developing new architectures and strategies aimed at expanding functionalities in an organized and scalable way. I work with the team on the creation and evolution of new features, bug fixes, and customer support. In addition, I strongly work on the creation and evolution of component libraries and tools that are used in all Technos Group apps to facilitate communication between applications and Bluetooth low energy devices.",
		],
		companyImage: radixLogo,
		techs: [
			"- React Native",
	...
	{
		title: "Nov/2021 - Nov/2022",
		cardTitle: "Junior Software Developer",
		cardSubtitle: "Radix Engineering and Software",
		cardDetailedText: [
			"During this period, I worked with the support team making bug fixes and occasional improvements in the Technos Group and VLT Carioca apps. During my time at Radix, I had the opportunity to work on various frontend, backend, and mobile projects, which made me a more complete professional and very self-taught.",
		],
		companyImage: radixLogo,
		techs: [
			"- In addition to the technologies mentioned in the current position, I also worked with:",
			"- Native Android Apps + MVVM",
			"- Retrofit",
			"- Backends in Ruby On Rails and .net C#",
			"- MySql and MongoDB",
			"- Aws S3",
			"- Azure Devops and Bitrise",
			"- Among other tools..."
		],
		companyLink: "https://www.radixeng.com.br/"
	},
	{
		...
		cardSubtitle: "Radix Engineering and Software",
		cardDetailedText: [
			"During this period, I worked with the Technos Group providing support and evolving React Native applications and Native Apps (Android and iOS).",
		],
		companyImage: radixLogo,
		techs: [],
		companyLink: "https://www.radixeng.com.br/"
	...
	{
		title: "Jul/2020 - Nov/2021",
		cardTitle: "Mobile Development Intern",
		cardSubtitle: "La Salle Abel College",
		cardDetailedText: [
			"Development of applications that assist educational projects proposed by teachers, as well as developing new ways to deepen the contents studied in the classroom using mobile applications.",
		],
		companyImage: lasalleLogo,
		techs: [
			"- Native Android Apps + MVVM",
